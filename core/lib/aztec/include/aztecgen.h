...
#ifdef __GNUC__
	#define AG_CDECL __attribute__((cdecl))
#else
...
#define AG_API(return_type) AG_EXTERN_C AG_EXPORT return_type AG_CDECL
#define AG_API_IMPL(return_type) AG_EXTERN_C return_type AG_CDECL
